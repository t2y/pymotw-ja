...
Development
  ...
  - Michael Schurter からの :mod:`select` モジュールサンプルの修正をマージ

1.132
  .. - 24 Oct 2010, rewrite :mod:`ConfigParser`

  - 2010年10月24日, :mod:`ConfigParser` を書き直し
...
1.131
  ...
  - 2010年10月17日, :mod:`sqlite3`
  - :mod:`xml.etree.ElementTree` を更新
  - :mod:`resource` を更新
  - :mod:`subprocess` を更新
  - :mod:`sys` を更新
  - :mod:`platform` のサンプル出力をよりモダンなシステム向けに再作成
  - :mod:`threading` を更新
  - :mod:`dircache` を更新
...
1.130
  ...
  - 2010年10月10日, :mod:`random`
  - :mod:`contextlib` を更新
  - :mod:`logging` を更新
  - :mod:`mmap` を更新
  - :mod:`csv` の dialects に関する詳細を追加
  - :mod:`difflib` を更新
  - :mod:`multiprocessing` を更新
  - :mod:`optparse` を更新
  - :mod:`pkgutil` を更新
...
1.128
  ...
  - 2010年9月28日, :class:`namedtuple` に対する *rename* 引数同様、 :class:`OrderedDict` や :class:`Counter` を追加するために :mod:`collections` を更新

1.127
  .. - 26 Sept 2010, :mod:`socket`

  - 2010年9月26日, :mod:`socket`

1.126
  .. - 19 Sept 2010, :mod:`sysconfig`

  - 2010年9月19日, :mod:`sysconfig`
