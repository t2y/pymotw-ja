...
==================================================================================
StringIO と cStringIO -- ファイルのような API を使用してテキストバッファと連携する
==================================================================================

.. module:: StringIO
    :synopsis: ファイルのような API を使用してテキストバッファと連携する
...
:目的: ファイルのような API を使用してテキストバッファと連携する
:Python バージョン: StringIO: 1.4, cStringIO: 1.5
