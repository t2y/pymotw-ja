...
::
	...
	Pattern : fnmatch_*.py
	Files   : ['fnmatch_fnmatchcase.py', 'fnmatch_filter.py', 'fnmatch_translate.py', '__init__.py', 'fnmatch_fnmatch.py', 'index.rst']
	Matches : ['fnmatch_fnmatchcase.py', 'fnmatch_filter.py', 'fnmatch_translate.py', 'fnmatch_fnmatch.py']
